...
cmd_dir="${SHARNESS_TEST_SRCDIR}/data/resource/commands/flexible_largest_fit"
exp_dir="${SHARNESS_TEST_SRCDIR}/data/resource/expected/flexible_largest_fit"
...
test_expect_success "${test001_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 001.R.out < cmds001 &&
...
test_expect_success "${test002_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 002.R.out < cmds002 &&
...
test_expect_success "${test003_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 003.R.out < cmds003 &&
...
test_expect_success "${test004_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 004.R.out < cmds004 &&
...
test_expect_success "${test005_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 005.R.out < cmds005 &&
...
test_expect_success "${test006_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit < cmds006 2>  006.R.out &&
...
test_expect_success "${test007_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 007.R.out < cmds007 &&
...
test_expect_success "${test008_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 008.R.out < cmds008 &&
...
test_expect_success "${test009_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 009.R.out < cmds009 &&
...
test_expect_success "${test010_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 010.R.out < cmds010 &&
...
test_expect_success "${test011_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 011.R.out < cmds011 &&
...
test_expect_success "${test012_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 012.R.out < cmds012 &&
...
test_expect_success "${test013_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 013.R.out < cmds013 &&
...
test_expect_success "${test014_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 014.R.out < cmds014 &&
...
test_expect_success "${test015_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P first -T flexible_largest_fit -t 015.R.out < cmds015 &&
...
test_expect_success "${test016_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -S CA -P high -T flexible_largest_fit -t 016.R.out < cmds016 &&
...
test_expect_success "${test017_desc}" '
    ...
    ${query} -L ${grug_small} -f grug -S CA -P low -T flexible_largest_fit -t 017.R.out < cmds017 &&
...
test_expect_success "${test018_desc}" '
    ...
    ${query} -L ${grug_small} -f grug -S CA -P first -T flexible_largest_fit -t 018.R.out < cmds018 &&
...
test_expect_success "${test019_desc}" '
    ...
    ${query} -L ${grug_small} -f grug -S CA -P high -T flexible_largest_fit -t 019.R.out < cmds019 &&
