...
#ifndef DFU_MATCH_MULTILEVEL_ID_COSCHED_HPP
#define DFU_MATCH_MULTILEVEL_ID_COSCHED_HPP
...
class multilevel_id_cosched_t : public dfu_match_cb_t {
   public:
    multilevel_id_cosched_t ();
    multilevel_id_cosched_t (const std::string &name);
    multilevel_id_cosched_t (const multilevel_id_cosched_t &o);
    multilevel_id_cosched_t &operator= (const multilevel_id_cosched_t &o);
    ~multilevel_id_cosched_t ();
    void count_free_under_u (vtx_t u,
   ...
   private:
    ...
    int64_t m_nwise = 2;
    int64_t m_core_id_start = -1;
    int64_t m_best_free = 0;
    int64_t m_best_free_i = 0;
    std::unordered_map<int64_t, int64_t> m_free_cores;
...
#endif  // DFU_MATCH_MULTILEVEL_ID_COSCHED_HPP
